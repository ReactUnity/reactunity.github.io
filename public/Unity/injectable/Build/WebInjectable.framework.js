...
var ASM_CONSTS = {
  6193236: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 6193291: ($0) => { performance.now = function() { return $0; }; },  
 6193339: ($0) => { performance.now = function() { return $0; }; },  
 6193387: () => { performance.now = Module['emscripten_get_now_backup']; }
};
